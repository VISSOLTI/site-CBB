...
const firebaseConfig = {
    apiKey: "AIzaSyD7CM0IFdASyNm97uzLpEpIecghmkOaRF0",
    authDomain: "inadimplencia-consolidado.firebaseapp.com",
    projectId: "inadimplencia-consolidado",
    storageBucket: "inadimplencia-consolidado.firebasestorage.app",
    messagingSenderId: "537580063160",
    appId: "1:537580063160:web:63c5ce26998c5d9a9ba74d"
};
...
function buscarDadosFirebase() {
    ...
    dadosRef.once('value', (snapshot) => {
        ...
        if (dados) {
            ...
            const ordemColunas = [
                "Super", "Vend", "Cód_Cliente", "Descr_Cliente","CPFA", "Cidade", "Grupo_Análise", "NF_CBB", "Data_Emissão", "Valor_Original", "Vencimento", "Valor_Atualizado", "Status_Cobrança", "Produto", "PF_PJ", 
"Ficha_Cadastro"
 ];

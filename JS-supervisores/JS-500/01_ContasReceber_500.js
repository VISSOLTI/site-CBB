...
const firebaseConfig = {
  apiKey: "AIzaSyB0fffCi24iKJzusSLQHAzPo1fmVkGiDWA",
  authDomain: "sup-2afc7.firebaseapp.com",
  databaseURL: "https://sup-2afc7-default-rtdb.firebaseio.com",
  projectId: "sup-2afc7",
  storageBucket: "sup-2afc7.firebasestorage.app",
  messagingSenderId: "293941769297",
  appId: "1:293941769297:web:276bbf400cb85a73957470"
};
...
function SelectData() {
  ...
  // Limpando o Código para remover os caracteres . / -
    ...
    get(child(dbref, cod_limpo)).then((snapshot) => {
        ...
        const headers = ['STATUS', 'Lançamento', 'NF/NFD', 'Emissão', 'Vencimento', 'Valor Original', 'Valor Desconto', 'Valor Abatimento', 'Valor Líquido', 'Valor Atualizado', 'Autorização NFD', 'Produto', 'Protesto-2', 'Código Boleto', 'Código Barras', 'Código Vendedor', 'Supervisor', 'Obs Pagamento'];
